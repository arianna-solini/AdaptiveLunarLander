...
class DQN_F:
    ...
    """ Deep Q Learning agent with fixed-Q-target """
    ...
    def experience_replay(self):
        ...
        # DQN model to predict the q_values
        target = self.dqn_network.predict(update_input)
        # Target model to predict the next q_values
        target_next = self.target_network.predict(update_target)
